...
impl StreamHandler<ws::Message, ws::ProtocolError> for WsChatSession {
    fn handle(&mut self, msg: ws::Message, ctx: &mut Self::Context) {
        ...
        // let p: MsgRecebida = serde_json::from_str(msg.into_text()).unwrap();

        // println!("WEBSOCKET MESSAGE: {:?}", p.author);
        // println!("WEBSOCKET MESSAGE: {:?}", p.message);
...
fn main() {
    ...
    println!("Started http server: 127.0.0.1:9876");
    let _ = sys.run();
}
